...
(192, 12,'¿Qué tan completa considera que es la información proporcionada en la plataforma web?', 1),
(194, 13,'¿Qué tan exhaustiva es la cobertura de los temas relevantes en la plataforma web?', 2),
(196, 1,'¿Qué tan satisfecho está con el nivel de detalle de la información proporcionada en la plataforma web?', 3),

-- SCAP (Satisfacción de control de acceso)
(212, 14,'¿Qué tan seguro se siente con respecto al control de acceso a sus datos personales en la plataforma web?', 1),
(214, 16,'¿Con qué frecuencia se le solicita autenticación adicional para acceder a información sensible?', 2),
(216, 5,'¿Qué tan fácil es para usted gestionar los permisos de acceso a sus datos personales?', 3),

-- STUD (Satisfacción de transparencia de uso de datos)
(225, 15,'¿Qué tan claro es para usted cómo se utilizan sus datos personales en la plataforma web?', 1),
(227, 5,'¿Qué tan fácil es acceder a la información sobre el uso de sus datos personales?', 2),
(229, 1,'¿Qué tan satisfecho está con la transparencia de la plataforma web respecto al uso de sus datos personales?', 3),

-- SVI (Satisfacción de verificabilidad de la información)
(237, 16,'¿Con qué frecuencia encuentra fuentes o referencias que respalden la información presentada en la plataforma web?', 1),
(239, 17,'¿Qué tan efectivos son los mecanismos de la plataforma web para verificar la autenticidad de la información?', 2),

-- SDIF (Satisfacción de detección de información falsa)
(244, 16,'¿Con qué frecuencia ha notado que la plataforma web identifica o marca información potencialmente falsa?', 1),
(246, 17,'¿Qué tan efectiva considera que es la plataforma web en la detección y manejo de información falsa?', 2),

-- SUV (Satisfacción del usuario con la verificación)
(251, 1,'¿Qué tan satisfecho está con los métodos de verificación de identidad utilizados por la plataforma web?', 1),
(253, 5,'¿Qué tan fácil es completar los procesos de verificación en la plataforma web?', 2),
(255, 18,'¿Qué tan confiables considera que son los mecanismos de verificación implementados en la plataforma web?', 3),
(257, 1,'¿Qué tan satisfecho está con la seguridad general proporcionada por los procesos de verificación?', 4),

-- SUT (Satisfacción del usuario con la trazabilidad)
(269, 5,'¿Qué tan fácil es para usted rastrear los cambios realizados en sus datos personales?', 1),
(271, 12,'¿Qué tan completa es la información de auditoría proporcionada sobre el acceso y modificación de sus datos?', 2),
(273, 19,'¿Qué tan útil encuentra la información de trazabilidad proporcionada por la plataforma web?', 3),
(275, 1,'¿Qué tan satisfecho está con la capacidad de la plataforma web para proporcionar un historial completo de sus datos?', 4),

-- SUNR (Satisfacción del usuario con no repudio)
(287, 20,'¿Qué tan confiado se siente de que las acciones realizadas en la plataforma web no pueden ser negadas posteriormente?', 1),
(289, 5,'¿Qué tan fácil es para usted obtener pruebas de las transacciones o acciones realizadas en la plataforma web?', 2),
(291, 15,'¿Qué tan claro es el proceso de generación de evidencias de no repudio en la plataforma web?', 3),
(293, 1,'¿Qué tan satisfecho está con los mecanismos de no repudio implementados en la plataforma web?', 4);
